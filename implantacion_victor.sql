...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-01-2023 a las 16:58:46
...
(1, 0, 'WhatsApp Image 2022-12-08 at 10.45.30 AM.jpeg', 'Libreta', '0', 100, 0, -2, 0),
(2, 101010, 'WhatsApp Image 2022-12-08 at 11.06.53 AM.jpeg', 'saul', '0', 100, 0, 0, 0),
(14, 312939, 'WhatsApp Image 2022-12-08 at 10.43.58 AM.jpeg', 'Craftword gold', 'lapicero', 30, 19, 18, 200),
(15, 323676987, 'WhatsApp Image 2022-12-08 at 10.44.35 AM.jpeg', 'Crayola', 'crayola', 47, 18, 75, 90),
(16, 875487584, 'WhatsApp Image 2022-12-08 at 10.44.20 AM.jpeg', 'Ohuhu marcadores', 'ohuhu 48 marcadores doble punta', 65, 11, 92269, 9894),
(17, 1101, 'WhatsApp Image 2022-12-08 at 10.45.13 AM.jpeg', 'Stabilo Boss', 'stabilo boss pastel amarillo ', 4, 10, -3, 15);
...
CREATE TABLE `proveedor` (
  ...
  `Nombre_proveedor` varchar(70) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `status_b` (
  ...
  `Nombre_status_B` varchar(70) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(88, 'PHP.jpeg', 'katherine ', 'alejandra', 'alvarado', 'mogollon', 'alejandra', 'd5cca9df47002e1f69e355be5a307497', 'V', '30123456', 'carora', 12, 151, 494, 215, 'Masculino', 'aleja01.com', '1234567', 1, 5, '2023-01-13 14:50:54.867952'),
...
INSERT INTO `ventas` (`Id_venta`, `Id_producto`, `Nombre_producto`, `cantidad`, `Precio`, `Precio_dolares`, `Id_usuario`, `fecha`) VALUES
(13, 2, 'crayola', 5, 100, 200, 5, '2023-01-11 12:03:34'),
(14, 2, 'crayola', 5, 100, 200, 5, '2023-01-11 12:04:30'),
(25, 16, 'Ohuhu marcadores', 1, 65, 11, 1, '2023-01-11 13:07:42'),
(26, 16, 'Ohuhu marcadores', 1, 65, 11, 1, '2023-02-01 22:45:29'),
(27, 16, 'Ohuhu marcadores', 1, 65, 11, 1, '2023-02-01 22:48:12'),
(33, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-01 23:37:51'),
(34, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-01 23:52:11'),
(35, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-01 23:53:46'),
(36, 17, 'Stabilo Boss', 1, 4, 10, 24, '2023-02-01 23:53:46'),
(37, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-02 00:10:29'),
(38, 17, 'Stabilo Boss', 1, 4, 10, 24, '2023-02-02 00:10:29'),
(39, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-02 00:11:23'),
(40, 17, 'Stabilo Boss', 1, 4, 10, 24, '2023-02-02 00:11:23'),
(41, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-02 00:12:11'),
(42, 17, 'Stabilo Boss', 1, 4, 10, 24, '2023-02-02 00:12:11'),
(43, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-02 00:13:11'),
(44, 17, 'Stabilo Boss', 1, 4, 10, 24, '2023-02-02 00:13:11'),
(45, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-02-02 00:13:42'),
(46, 17, 'Stabilo Boss', 1, 4, 10, 24, '2023-02-02 00:13:42'),
(47, 1, 'Libreta', 1, 100, 0, 24, '2023-01-13 16:11:45'),
(48, 16, 'Ohuhu marcadores', 1, 65, 11, 24, '2023-01-14 15:54:56');
...
ALTER TABLE `empresa`
  ...
  ADD KEY `empresa_ibfk_1` (`Id_estado`),
  ADD KEY `empresa_ibfk_2` (`Id_municipio`),
  ADD KEY `empresa_ibfk_3` (`Id_parroquia`),
  ADD KEY `empresa_ibfk_4` (`Id_ciudad`);
...
ALTER TABLE `proveedor`
  ...
  ADD KEY `proveedor_ibfk_1` (`Id_producto`),
  ADD KEY `proveedor_ibfk_2` (`Id_estado`),
  ADD KEY `proveedor_ibfk_3` (`Id_municipio`),
  ADD KEY `proveedor_ibfk_4` (`Id_parroquia`),
  ADD KEY `proveedor_ibfk_5` (`Id_ciudad`);
...
ALTER TABLE `status_usuario`
  ADD KEY `status_ibfk_1` (`Id_usuario`),
  ADD KEY `status_ibfk_2` (`Id_perfil`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `usuarios_ibfk_1` (`Id_status_B`),
  ADD KEY `usuarios_ibfk_2` (`Id_perfil`),
  ADD KEY `usuario_estado` (`id_estado`),
  ADD KEY `usuario_minicipio` (`id_municipio`),
  ADD KEY `usuarios_parroquia` (`id_parroquia`),
...
--
ALTER TABLE `status_b`
  MODIFY `Id_status_B` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `tipo_pago`
--
ALTER TABLE `tipo_pago`
  MODIFY `Id_tipo_pago` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`Id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `empresa_ibfk_2` FOREIGN KEY (`Id_municipio`) REFERENCES `municipios` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `empresa_ibfk_3` FOREIGN KEY (`Id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `proveedor`
  ...
  ADD CONSTRAINT `proveedor_ibfk_2` FOREIGN KEY (`Id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `proveedor_ibfk_3` FOREIGN KEY (`Id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `proveedor_ibfk_4` FOREIGN KEY (`Id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `proveedor_ibfk_5` FOREIGN KEY (`Id_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `status_usuario`
--
ALTER TABLE `status_usuario`
  ADD CONSTRAINT `status_ibfk_1` FOREIGN KEY (`Id_usuario`) REFERENCES `usuarios` (`Id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `status_ibfk_2` FOREIGN KEY (`Id_perfil`) REFERENCES `perfiles_usuario` (`Id_perfil`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `usuario_minicipio` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `usuarios_ciudad` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
